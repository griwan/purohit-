      ...
      <div className="mt-8 flex justify-around">
        <div className="relative text-center w-1/5">
          ...
          >
            ...
            <div className="text-xs 2xl:text-1.5rem 2xl:leading-6 font-sans max-w-[12rem] 2xs:max-w-[9rem]">
        ...
        <div className="relative text-center w-1/5">
          <img
            src="/s3-2-3.svg"
            className="m-auto mb-3 2xl:mb-6 w-[75px] w-[75px] 2xl:h-[152px] 2xl:w-[152px]"
          />
          <div
            className="text-red  absolute top-1/2 left-1/2"
            style={{ transform: "translate(-50%, -50%)" }}
