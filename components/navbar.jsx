...
export default function NavBar() {
  ...
  const ModuleB = () => (
    <div className={moduleBClass}>
      ...
      <section className="flex flex-1 justify-center"></section>
      <section className="md:text-xs lg:text-lg lg:text-lg flex flex-1 justify-center">
        MODULE B
      </section>
      <section className="flex flex-1 justify-center"></section>
    ...
    return (
      <>
        <div className="flex text-white max-h-[6vh] min-h-[6vh] text-1.25rem leading-6 font-sans">
          ...
          <ModuleASection />
          <ModuleB />
          <div className="md:text-xs lg:text-lg bg-[#333333] w-1/12 flex justify-center items-center">
            End
          </div>
        </div>
      </>
