...
const HIV = () => {
  return (
    <div className="flex flex-col items-center text-center mt-5 2xl:mt-20">
      <div className="h-full text-white flex justify-center text-8.5rem text-[#557996] gap-4">
        <div className="flex flex-col basis-3/12 items-center m-0 p-0">
          ...
          <div className="text-base 2xl:text-2xl text-gray-500 2xl:w-[19rem]">
        ...
        <div className="flex flex-col basis-3/12 items-center">
          ...
          <div className="text-base 2xl:text-2xl text-gray-500 2xl:w-[33rem]">
