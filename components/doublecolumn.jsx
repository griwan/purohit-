...
const DoubleColumn = () => {
  return (
    <div className="flex flex-row justify-center gap-4 mt-[1rem] 2xl:mt-[6rem] font-sans">
      <div className="flex flex-col w-6/12 2xl:w-[28rem] gap-1 2xl:gap-4">
        <div>
          <Image src="/threenext.svg" alt="next" width={120} height={120} />
        </div>
        <div className="text-red fluid3xl">What next?</div>
        <div className="fluid2xl text-[#707070] 2xl:leading-7">
          If someone’s test result comes back positive, it is important to
          remind them the following about STIs:
        </div>
        <div className="fluid2xl text-[#476A8A] 2xl:leading-7">
          Some are curable. Most are treatable. All are manageable.<sup>1</sup>{" "}
          A healthcare provider can help figure out what treatment is right.
        </div>
      </div>
      <div className="flex flex-col w-6/12 2xl:w-[44rem] gap-1 2xl:gap-4">
        ...
        <div className="text-red fluid3xl">What’s the deal with retesting?</div>
        <div className="fluid2xl text-[#707070] 2xl:leading-7">
