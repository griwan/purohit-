...
const DoubleColumn = () => {
  return (
    <div className="flex flex-row justify-evenly mt-[6rem] font-sans">
      <div className="flex flex-col w-5/12 mx-auto xl:w-[28rem] gap-1 xl:gap-4">
        <div>
          <Image src="/threenext.svg" alt="next" width={120} height={120} />
        </div>
        <div className="text-red text-lg xl:text-3xl">What next?</div>
        <div className="text-base xl:text-2xl text-[#707070] xl:leading-7">
          If someone’s test result comes back positive, it is important to
          remind them the following about STIs:
        </div>
        <div className="text-base xl:text-2xl text-[#476A8A] xl:leading-7">
      ...
      <div className="flex flex-col w-5/12 xl:w-[44rem] gap-1 xl:gap-4">
        <div>
          <Image src="/sui.png" alt="next" width={320} height={120} />
        </div>
        <div className="text-red text-2xl xl:text-3xl">
