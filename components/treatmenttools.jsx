  ...
  return (
    <div className="flex flex-col items-center justify-center gap-10 picture-wrapper">
      <section className="flex text-ui-text font-sans w-4/5 mx-auto">
        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4 text-right h-max">
          <p className="text-3xl text-red font-medium pb-2">
        ...
        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4 h-max text-center">
          <Image
            src="/Group_501.svg"
            alt="Group 501"
            height={200}
        ...
        <div className="lg:w-1/3 lg:mb-0 p-4 h-max text-left">
          <p className="text-3xl text-red font-medium pb-2">
